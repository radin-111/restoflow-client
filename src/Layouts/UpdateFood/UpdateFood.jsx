...
const UpdateFood = () => {
    ...
    const { category, description, foodName, imageUrl, origin, price, quantity, _id, addedByEmail } = data;
    ...
    const handleSubmit = (e) => {
        ...
        axios.put(`https://restaurant-management-server-bay.vercel.app/update/${_id}`, form)
            .then(r => {
        ...
        <div className="bg-gradient-to-br from-indigo-100 via-white to-indigo-200 min-h-screen py-10 px-4 flex items-center justify-center">
            {
                user?.email == addedByEmail ?
                    ...
                    >
                        <h1 className="text-3xl font-bold text-indigo-700 text-center">🍔 Update Food Item</h1>

                        <fieldset className="grid grid-cols-1 md:grid-cols-2 gap-6">

                            <div>
                                <label className="block mb-2 font-medium text-gray-700">Food Name</label>
                                <input
                                    type="text"
                                    name="foodName"
                            ...
                            <div>
                                <label className="block mb-2 font-medium text-gray-700">Origin Country</label>
                                <input
                                    type="text"
                                    name="origin"
                                    defaultValue={origin}
                            ...
                            <div>
                                <label className="block mb-2 font-medium text-gray-700">Added By (Name)</label>
                                <input
                                    type="text"
                                    name="addedByName"
                                    defaultValue={user ? user.emailVerified ? user.displayName : cUser && cUser.name : ''}
                                    readOnly
                            ...
                            <div>
                                <label className="block mb-2 font-medium text-gray-700">Added By (Email)</label>
                                <input
                                    type="email"
                                    name="addedByEmail"
